...
io.on('connection', (socket) => {
    ...
    console.log('🌐 Origen de la conexión:', socket.handshake.headers.origin);
...
try {
    ...
    const main = async () => {
        ...
        if (!isProduction) {
            console.log('🚪 Iniciando portal de QR en modo desarrollo...');
            QRPortalWeb();
        } else {
            console.log('🚪 Portal de QR deshabilitado en producción');
        }
